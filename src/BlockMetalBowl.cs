...
{
    /// <summary>
    /// The empty metal bowl. Behaves exactly like the vanilla top opened liquid container,
    /// except that whatever it holds spoils slower on higher metal tiers.
    /// </summary>
    public class BlockMetalBowl : BlockLiquidContainerTopOpened
    {
